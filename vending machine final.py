...
def snacks_function():
    ...
    while True:
        ...
        engine.runAndWait()
        snacks_input = input("ENTER THE NUMBER YOU DESIIIIRE(or 'back' to return): ")
...
money = int(input("HELLO AND WELCOME TO THE VENDING MACHINE, HOW MUCH COINS WOULD YOU LIKE TO ENTER?"))
